...
CREATE TABLE `userimage` (
  ...
  PRIMARY KEY (`file_id`),
  KEY `userId` (`userId`),
  CONSTRAINT `userimage_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE
...
INSERT INTO `userimage` VALUES (1,2,'230525','캡처.PNG','2a51ba8b-174e-48b2-ab98-015737a31c2b.PNG');
