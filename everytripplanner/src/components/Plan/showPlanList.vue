<template>
    <div id="asdasd">
        ...
        <b-modal id="modal-1" title="BootstrapVue" v-model="showModal" @ok="myData()" hide-header-close @cancel="gotoMain" cancel-title="메인" ok-title="작성" no-close-on-esc
...
export default {
    ...
    computed: {
        ...mapState(planStore, ["planItems",'selectedDayNum','dayNum',"planNameAdd",'selectedDayNum']),
